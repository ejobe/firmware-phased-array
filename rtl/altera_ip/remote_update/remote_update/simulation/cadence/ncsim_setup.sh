...
# ACDS 15.1 185 win32 2017.10.20.16:48:47
...
# # End of template
# ----------------------------------------
# If remote_update is one of several IP cores in your
...
mkdir -p ./libraries/remote_update_0/
...
if [ $SKIP_COM -eq 0 ]; then
  ncvhdl -v93 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_remote_update_core.vhd"     -work remote_update_core -cdslib ./cds_libs/remote_update_core.cds.lib
  ncvhdl -v93 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/remote_update_remote_update_0.vhd" -work remote_update_0    -cdslib ./cds_libs/remote_update_0.cds.lib   
  ncvhdl -v93 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/remote_update.vhd"                                                                                                  
fi
