...
set_false_path -from {top_level:inst4|sys_reset:xGLOBAL_RESET|pulse_stretcher_sync:xUSER_RESET|pulse_o} -to *
set_false_path -from {top_level:inst4|sys_reset:xGLOBAL_RESET|pulse_stretcher_sync:xUSER_SYS_RESET|pulse_o} -to *
set_false_path -from {top_level:inst4|sys_reset:xGLOBAL_RESET|fpga_reset_pwr} -to *
set_false_path -from {top_level:inst4|sys_reset:xGLOBAL_RESET|pulse_stretcher_sync:xADC_RESET|pulse_o} -to *
